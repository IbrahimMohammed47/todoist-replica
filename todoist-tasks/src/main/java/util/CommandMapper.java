...
//		serviceMap.put("createTodolist", CreateTodolistCommand.class);
//		serviceMap.put("addTask", AddTaskCommand.class);
//		serviceMap.put("removeTask", RemoveTaskCommand.class);
//		serviceMap.put("viewSortedTodolist", ViewSortedTodolist.class);
//		serviceMap.put("viewSortedBoard", ViewSortedBoard.class);
//
//		serviceMap.put("toggleTask", ToggleTaskCommand.class);
//		serviceMap.put("changeDueDate", ChangeDueDateCommand.class);
//		serviceMap.put("changePriority", ChangePriorityCommand.class);
//		serviceMap.put("assignTask", AssignTaskCommand.class);
//		serviceMap.put("viewUpcomingTasksDeadLine", ViewUpcomingTasksDeadlineCommand.class);
		serviceMap = new ConcurrentHashMap<>();
		try
		{
